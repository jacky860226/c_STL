...
void *copy_backward(void *first,void *last,void *result,int data_size){
	while(first!=last)
		memcpy(result-=data_size,last-=data_size,data_size);
	return result;
}
void __unguarded_linear_insert(void *last,void *val,int data_size,int (*cmp)(const void *,const void *)){
	void *next=last;
	next-=data_size;
...
void __insertion_sort(void *first,void *last,int data_size,int (*cmp)(const void *,const void *)){
	if(first==last)return;
...
bool next_permutation(void *first,void *last,int data_size,int (*cmp)(const void *,const void *)){
...
bool prev_permutation(void *first,void *last,int data_size,int (*cmp)(const void *,const void *)){
	if(first==last)return false;
	void *i=first;
	i+=data_size;
	if(i==last)return false;
...
void partial_sort(void *first,void *middle,void *last,int data_size,int (*cmp)(const void *,const void *)){
	__heap_select(first,middle,last,data_size,cmp);
	sort_heap(first,middle,data_size,cmp);
}
void __move_median_first(void *a,void *b,void *c,int data_size,int (*cmp)(const void *,const void *)){
	if(cmp(a,b)<0){
...
void *__unguarded_partition(void *first,void *last,void *pivot,int data_size,int (*cmp)(const void *,const void *)){
	while(true){
...
void *__unguarded_partition_pivot(void *first,void *last,int data_size,int (*cmp)(const void *,const void *)){
...
void __introselect(void *first,void *nth,void *last,int data_size,int depth_limit,int (*cmp)(const void *,const void *)){
	while(last-first>3*data_size){
		if(depth_limit==0){
